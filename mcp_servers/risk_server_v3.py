...
if __name__ == "__main__":
    print("Starting UW Risk Tools MCP Server v3 on http://127.0.0.1:8001")
    print("Changes: calibrated crime index (* 1.0), static flood zone layer")
    print("Tools: get_flood_zone, get_crime_index, get_claims_history,")
    print("       validate_submission, get_flight_schedule (irrelevant — test tool)")
